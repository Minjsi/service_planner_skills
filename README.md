...
### 1. 클로드에게 시키기
git clone 또는 파일 복사 등으로 이 레포의 스킬 파일들을 클로드가 접근할 수 있는 위치에 저장

클로드에게 스킬 파일들이 저장된 경로를 알려주고, 해당 스킬들을 로드하도록 요청합니다.

![img.png](claude_question1.png)
![img_1.png](claude_question2.png)
